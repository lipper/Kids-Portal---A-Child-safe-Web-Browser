    ...
    class Checker
    {
        ...
        public void checkTerms(KidsPortal kp)
        {
            ...
            for (int x = 0; x < terms.Length; x++)
            {
                ...
                if (texts.Split().Contains(terms[x], StringComparer.CurrentCultureIgnoreCase))
                {
                    count++;
                    positive += terms[x] + "\n";
                    positives += terms[x] + " ";
